(function (factory) {
  ...
  var createVideoNode = function (url) {
    ...
    $container = $('<div>').addClass('video-container').html($video[0]);

    return $container[0];
    //return '<div class= "video-container">'+$video[0]+'</div>';
  };
    ...
    dialogs: {
      video: function (lang) {
        var body = '<div class="form-group row-fluid">' +
                   ...
                   '</div>';
        var footer = '<button href="#" class="btn note-video-btn disabled" disabled>' + lang.video.insert + '</button>';
